...
module Text.Reprinter.Examples.Simple where
...
-- TODO: Re-export anything needed through reprinter
...
main = do
    putStrLn "Refactoring: remove additions of zero."
    test input
    putStrLn "\nRefactoring: append evaluated variables in comments."
    test2 input
